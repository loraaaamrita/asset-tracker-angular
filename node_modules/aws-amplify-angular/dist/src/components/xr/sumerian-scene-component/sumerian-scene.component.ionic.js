...
var SumerianSceneComponentIonic = /** @class */ (function (_super) {
    __extends(SumerianSceneComponentIonic, _super);
    function SumerianSceneComponentIonic(amplifyService) {
        var _this = _super.call(this, amplifyService) || this;
        _this.amplifyService = amplifyService;
        return _this;
    }
    SumerianSceneComponentIonic.decorators = [
        { type: Component, args: [{
    ...
    /** @nocollapse */
    SumerianSceneComponentIonic.ctorParameters = function () { return [
        { type: AmplifyService, },
    ]; };
    return SumerianSceneComponentIonic;
}(SumerianSceneComponentCore));
export { SumerianSceneComponentIonic };
//# sourceMappingURL=sumerian-scene.component.ionic.js.map